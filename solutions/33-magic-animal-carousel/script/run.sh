...
# INSTANCE=0xE2Cd7e938a784a85beeA4E026164c2c29196CA08
...
forge script script/MagicAnimalCarousel.s.sol:MagicAnimalCarouselScript --rpc-url $RPC_URL --private-key $PRIVATE_KEY --broadcast -vvvv --evm-version cancun
